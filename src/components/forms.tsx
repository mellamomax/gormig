...
export function ManualScrapeForm() {
  return (
    <form action={scrapePostsAction} className="grid gap-4 rounded border border-[var(--line)] bg-[var(--panel)] p-4">
      ...
      <p className="text-sm leading-6 text-slate-600">Hämtar senaste TikTok-posterna via Apify och sparar nya länkar i databasen. Ingen analys startas automatiskt.</p>
